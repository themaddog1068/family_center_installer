...
PACKAGE_URL="https://raw.githubusercontent.com/themaddog1068/family_center_installer/main/family_center_complete_v10.zip"
...
echo -e "${YELLOW}📥 Downloading Family Center working package (from main branch)...${NC}"
if curl -L -o family_center_working_v5.zip "$PACKAGE_URL"; then
